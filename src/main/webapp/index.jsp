					...
					<div class="slider_contant text-center"
						...
						<div class="input-group mb-3">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="#">상품명</a> <a
										class="dropdown-item" href="#">제조사</a> <a
										class="dropdown-item" href="#">영양소</a>
								</div>
							</div> -->
								...
								<div class="col-5" style="padding:0px !important;">
									<input type="text" class="form-control"
										aria-label="Text input with dropdown button" value="검색어 입력">
								</div>
				...
				<div class="row">
					<div class="col-xl-4 col-md-6">
						<div class="single_service">
							...
							<h4>식품 영양정보 관리</h4>
							<p>공공데이터를 통해 식품별 첨가물, 영양 정보를 파싱하여 관리하고, 식품별, 제조사별, 원재료별 검색
								기능을 제공</p>
						</div>
					</div>
					<div class="col-xl-4 col-md-6">
